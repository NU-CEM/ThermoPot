...
BaZrS3_calc = calculations.AimsCalculation(
    "../BaZrS3/raw_aims_files/ternary/BaZrS3_Pnma/hse06/aims.out"
)
Ba2ZrS4_calc = calculations.AimsCalculation(
    "../BaZrS3/raw_aims_files/ternary/Ba2ZrS4_I4_mmm/hse06/aims.out"
)
ZrS2_calc = calculations.AimsCalculation(
    "../BaZrS3/raw_aims_files/binary/ZrS2_P-3m1/hse06/aims.out"
)
